...
resource "appleads_campaign" "hierarchy" {
...
resource "appleads_ad_group" "hierarchy" {
  campaign_id               = appleads_campaign.hierarchy.id
...
resource "appleads_keyword" "exact" {
  ad_group_id  = appleads_ad_group.hierarchy.id
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.appleads_app.app", "adam_id"),
					resource.TestCheckResourceAttrSet("appleads_campaign.hierarchy", "id"),
					resource.TestCheckResourceAttrSet("appleads_ad_group.hierarchy", "id"),
					resource.TestCheckResourceAttrSet("appleads_keyword.exact", "id"),
					resource.TestCheckResourceAttrSet("appleads_keyword.broad", "id"),
					...
					resource.TestCheckResourceAttrPair("appleads_ad_group.hierarchy", "campaign_id", "appleads_campaign.hierarchy", "id"),
					resource.TestCheckResourceAttrPair("appleads_keyword.exact", "ad_group_id", "appleads_ad_group.hierarchy", "id"),
					resource.TestCheckResourceAttrPair("appleads_keyword.exact", "campaign_id", "appleads_campaign.hierarchy", "id"),
					resource.TestCheckResourceAttrPair("appleads_negative_keyword.campaign", "campaign_id", "appleads_campaign.hierarchy", "id"),
					resource.TestCheckResourceAttrPair("appleads_negative_keyword.adgroup", "ad_group_id", "appleads_ad_group.hierarchy", "id"),
					func(s *terraform.State) error {
						campaignID = s.RootModule().Resources["appleads_campaign.hierarchy"].Primary.ID
						adGroupID = s.RootModule().Resources["appleads_ad_group.hierarchy"].Primary.ID
						return nil
					},
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					func(s *terraform.State) error {
						rs := s.RootModule().Resources["appleads_campaign.hierarchy"]
