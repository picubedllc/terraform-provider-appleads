...
page_title: "appleads_keyword Resource - appleads"
subcategory: ""
description: |-
...
- `ad_group_id` (String) Parent ad group id (immutable). Changing this after create returns an error; create a new appleads_keyword instead.
