...
```bash
terraform import appleads_negative_keyword.campaign_free campaign/111/555
terraform import appleads_negative_keyword.adgroup_cheap adgroup/111/222/666
# Or without campaign id (resolved via ad group find):
terraform import appleads_negative_keyword.adgroup_cheap adgroup/222/666
```
